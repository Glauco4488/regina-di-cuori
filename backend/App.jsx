          ...
          <div style={{ borderTop:"1px solid #3d0000", borderBottom:"1px solid #3d0000", marginBottom:8, flexShrink:0, padding:"clamp(8px,2vw,14px) 0", position:"relative" }}>
            ...
            {started && (
              <div style={{ position:"absolute", right:0, top:"50%", transform:"translateY(-50%)", display:"flex", gap:6 }}>
                <button onClick={saveDialog} style={{ background:"transparent", border:"1px solid #5a3a1a", borderRadius:3, color:"#D4AF37", fontSize:11, padding:"3px 8px", cursor:"pointer", fontFamily:ff }}>Salva</button>
                <button onClick={resetDialog} style={{ background:"transparent", border:"1px solid #8B1A1A", borderRadius:3, color:"#8B3333", fontSize:11, padding:"3px 8px", cursor:"pointer", fontFamily:ff }}>Nuova Udienza</button>
              </div>
            )}
          </div>
