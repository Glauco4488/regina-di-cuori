...
export default function App() {
  ...
  return (
    <div style={{ height:"100vh", width:"100%", background:"radial-gradient(ellipse at center, #2a0000 0%, #0d0000 70%)", display:"flex", alignItems:"center", justifyContent:"center", padding:"clamp(10px,2vw,24px)", boxSizing:"border-box", fontFamily:ff }}>
      ...
      <div style={{
        width:"100%", maxWidth:"calc(820px + 160px)", height:"clamp(660px,calc(90vh + 160px),calc(95vh + 160px))",
        padding:80, boxSizing:"border-box", position:"relative",
        borderStyle:"solid", borderWidth:"80px",
        borderImageSource:"url(/frame-gold.png)", borderImageSlice:30, borderImageWidth:"80px", borderImageRepeat:"stretch",
        filter:"drop-shadow(0 0 45px rgba(0,0,0,0.75)) drop-shadow(0 0 90px rgba(0,0,0,0.5))"
      }}>

      <div style={{ width:"100%", maxWidth:820, height:"clamp(500px,90vh,95vh)", position:"relative", display:"flex", flexDirection:"column", background:"linear-gradient(160deg,#1a0000 0%,#2a0000 50%,#1a0008 100%)", borderRadius:12, boxShadow:"0 0 60px rgba(192,57,43,0.2), 0 0 120px rgba(0,0,0,0.8)" }}>
